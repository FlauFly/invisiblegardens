...
export default function PostLayout({ content, children }: LayoutProps) {
  const { slug, date, title, cover, genres, director, writer, published, language, country } =
    content
            ...
            <div className="flex flex-col gap-10 space-x-10 sm:flex-row">
              ...
              <div className="mt-8 flex flex-col text-center">
                ...
                <div className="flex flex-col gap-2 md:flex-row">
                  <div className="text-gray-500">Writer:</div>
                  <div>{writer?.join(', ')}</div>
                </div>
                <div className="flex flex-col gap-2 md:flex-row">
                ...
                <div className="flex flex-col gap-2 md:flex-row">
                  <div className="text-gray-500">Country of origin:</div>
                  <div>{country}</div>
                </div>
                <div className="mb-4 mt-auto flex flex-col gap-2 md:flex-row">
                  <div className="text-gray-500">Watched:</div>
                  <div>
                    <div className="sr-only">Watched</div>
